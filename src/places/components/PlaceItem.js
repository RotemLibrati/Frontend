...
const PlaceItem = (props) => {
    ...
    return (
        <React.Fragment>
            ...
            <Modal show={showConfirmModal} onCancel={cancelDeleteHnadler} header="Are you sure?" footerClass="place-item__modal-actions" footer={
                <React.Fragment>
                    <Button inverse onClick={cancelDeleteHnadler}>CANCEL</Button>
                    <Button danger onClick={confirmDeleteHnadler}>DELETE</Button>
                </React.Fragment>
            }>
                <p>Do you want to proceed and delete this place ? Please note that it cant be undone the</p>
            </Modal>
